...
var $author$project$I18n$ErrorCorruptedSession = {$: 'ErrorCorruptedSession'};
var $author$project$Game$Errored = function (a) {
	return {$: 'Errored', a: a};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Keyboard$Auto = {$: 'Auto'};
...
var $author$project$Store$default = function (lang) {
	return {helpViewed: false, lang: lang, logs: _List_Nil, settings: $author$project$Settings$default};
};
		...
		_List_fromArray(
			[
				...
				$elm$json$Json$Encode$int(
					$elm$time$Time$posixToMillis(log.time))),
				_Utils_Tuple2(
				'lang',
				$elm$json$Json$Encode$string(
					$author$project$I18n$langToString(log.lang))),
				_Utils_Tuple2(
				'word',
				$elm$json$Json$Encode$string(log.word)),
				_Utils_Tuple2(
				'victory',
				$elm$json$Json$Encode$bool(log.victory)),
				_Utils_Tuple2(
				'guesses',
				$elm$json$Json$Encode$int(log.guesses))
			]));
};
...
var $author$project$Keyboard$encodeLayout = function (layout) {
	return $elm$json$Json$Encode$string(
		$author$project$Keyboard$layoutToString(layout));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'layout',
				$author$project$Keyboard$encodeLayout(v.layout)),
				_Utils_Tuple2(
				'wordSize',
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $elm$json$Json$Encode$int, v.wordSize)))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				'lang',
				$elm$json$Json$Encode$string(
					$author$project$I18n$langToString(store.lang))),
				_Utils_Tuple2(
				'logs',
				A2($elm$json$Json$Encode$list, $author$project$Log$encode, store.logs)),
				_Utils_Tuple2(
				'helpViewed',
				$elm$json$Json$Encode$bool(store.helpViewed)),
				_Utils_Tuple2(
				'settings',
				$author$project$Settings$encode(store.settings))
			]));
};
var $author$project$Store$toJson = A2(
	$elm$core$Basics$composeR,
	$author$project$Store$encode,
...
var $author$project$Store$Store = F4(
	function (lang, logs, helpViewed, settings) {
		return {helpViewed: helpViewed, lang: lang, logs: logs, settings: settings};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$Log$Log = F5(
	function (time, lang, word, victory, guesses) {
		return {guesses: guesses, lang: lang, time: time, victory: victory, word: word};
	});
...
var $author$project$Log$decode = A6(
...
var $author$project$Settings$Settings = F2(
	function (layout, wordSize) {
		return {layout: layout, wordSize: wordSize};
	});
var $author$project$Keyboard$Azerty = {$: 'Azerty'};
var $author$project$Keyboard$Qwerty = {$: 'Qwerty'};
...
var $author$project$Settings$decode = A4(
	...
	A4(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
		'layout',
		$author$project$Keyboard$decodeLayout,
...
var $author$project$Store$decode = A4(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
	'settings',
	$author$project$Settings$decode,
	$author$project$Settings$default,
	A4(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
		'helpViewed',
		...
		A3(
			...
			'logs',
			$elm$json$Json$Decode$list($author$project$Log$decode),
			A3(
				$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'lang',
				A2($elm$json$Json$Decode$map, $author$project$I18n$langFromString, $elm$json$Json$Decode$string),
				$elm$json$Json$Decode$succeed($author$project$Store$Store)))));
var $elm$json$Json$Decode$decodeString = _Json_runOnString;
var $author$project$Store$fromJson = $elm$json$Json$Decode$decodeString($author$project$Store$decode);
var $author$project$Main$HelpModal = {$: 'HelpModal'};
...
var $author$project$Notif$config = A2(
...
var $author$project$Main$notifyWarning = F2(
	function (i18nId, _v0) {
		var model = _v0.a;
		var cmds = _v0.b;
		return A3(
			$author$project$Notif$add,
			$author$project$Main$ToastyMsg,
			$author$project$Notif$Warning(
				A2($author$project$I18n$translate, model.store.lang, i18nId)),
...
var $author$project$Main$WordsReceived = function (a) {
	return {$: 'WordsReceived', a: a};
};
var $author$project$Main$UpdateWordSize = function (a) {
	return {$: 'UpdateWordSize', a: a};
};
...
var $author$project$Main$getRandomWordSize = A2(
	$elm$random$Random$generate,
	$author$project$Main$UpdateWordSize,
	A2($elm$random$Random$int, 5, 7));
...
var $author$project$Client$getWords = F2(
	function (lang, msg) {
...
var $author$project$Main$startNewGame = function (_v0) {
	...
	if (_v1.$ === 'Just') {
		return A2($author$project$Client$getWords, lang, $author$project$Main$WordsReceived);
	} else {
...
var $author$project$Main$init = function (flags) {
	var _v0 = function () {
		...
		if (_v1.$ === 'Ok') {
			var store = _v1.a;
			return _Utils_Tuple2(
				$author$project$Main$initialModel(store),
				$elm$core$Platform$Cmd$none);
		} else {
			var error = _v1.a;
			var store = $author$project$Store$default(
				$author$project$I18n$parseLang(flags.lang));
			var newModel = $author$project$Main$initialModel(store);
			return A2(
				$author$project$Main$notifyWarning,
				$author$project$I18n$ErrorCorruptedSession,
				_Utils_Tuple2(
					_Utils_update(
						newModel,
						{
							state: $author$project$Game$Errored(
								$author$project$Game$DecodeError(
									$elm$json$Json$Decode$errorToString(error)))
						}),
		...
		function (key) {
			...
			if ((_v1.$ === 'Just') && (_v1.a.b === '')) {
				...
				return $elm$core$Char$isAlpha(_char) ? $elm$json$Json$Decode$succeed(
					onKeyPress(_char)) : $elm$json$Json$Decode$fail('discarded char');
			} else {
				return (key === 'Backspace') ? $elm$json$Json$Decode$succeed(onBackSpace) : ((key === 'Enter') ? $elm$json$Json$Decode$succeed(onEnter) : ((key === 'Escape') ? $elm$json$Json$Decode$succeed(onEscape) : $elm$json$Json$Decode$fail('discarded key')));
			}
		},
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$Main$storeChanged(
				A2($elm$core$Basics$composeR, $author$project$Store$fromJson, $author$project$Main$StoreChanged)),
				function () {
				if (state.$ === 'Ongoing') {
					return $elm$browser$Browser$Events$onKeyDown(
						$author$project$Event$decodeKey(
							{onBackSpace: $author$project$Main$BackSpace, onEnter: $author$project$Main$Submit, onEscape: $author$project$Main$CloseModal, onKeyPress: $author$project$Main$KeyPressed}));
				} else {
...
var $author$project$Game$LoadError = {$: 'LoadError'};
var $author$project$I18n$LoadError = {$: 'LoadError'};
var $author$project$I18n$NewGameLang = function (a) {
	return {$: 'NewGameLang', a: a};
};
var $author$project$Game$Ongoing = F3(
	function (a, b, c) {
		return {$: 'Ongoing', a: a, b: b, c: c};
	});
var $elm$core$String$cons = _String_cons;
var $elm$core$String$fromChar = function (_char) {
	return A2($elm$core$String$cons, _char, '');
};
var $author$project$Main$addChar = F3(
	function (wordSize, _char, input) {
		return A3(
			$elm$core$String$slice,
			0,
			wordSize,
...
var $author$project$Game$Lost = F2(
	function (a, b) {
		return {$: 'Lost', a: a, b: b};
	});
var $author$project$Game$Won = F2(
	function (a, b) {
		return {$: 'Won', a: a, b: b};
	});
...
var $author$project$Game$checkGame = F3(
	function (maxAttempts, word, guesses) {
		return $author$project$Game$hasWon(guesses) ? A2($author$project$Game$Won, word, guesses) : ((_Utils_cmp(
			$elm$core$List$length(guesses),
			maxAttempts) > -1) ? A2($author$project$Game$Lost, word, guesses) : A3($author$project$Game$Ongoing, word, guesses, ''));
	});
...
var $author$project$Store$addLog = F2(
	function (log, store) {
		var logs = store.logs;
...
var $author$project$Main$logResult = function (_v0) {
	...
	if (logData.$ === 'Just') {
		...
		var newStore = A2(
			$author$project$Store$addLog,
			{guesses: nbAttempts, lang: store.lang, time: time, victory: victory, word: word},
			store);
		return _Utils_Tuple2(
			_Utils_update(
				model,
...
var $author$project$Main$notifySuccess = F2(
	function (i18nId, _v0) {
		var model = _v0.a;
		var cmds = _v0.b;
		return A3(
			$author$project$Notif$add,
			$author$project$Main$ToastyMsg,
			$author$project$Notif$Success(
				A2($author$project$I18n$translate, model.store.lang, i18nId)),
			_Utils_Tuple2(model, cmds));
	});
var $author$project$I18n$GameLost = {$: 'GameLost'};
var $author$project$I18n$GameWin = {$: 'GameWin'};
var $author$project$Notif$Info = function (a) {
	return {$: 'Info', a: a};
};
var $author$project$Main$notifyInfo = F2(
	function (i18nId, _v0) {
		var model = _v0.a;
		var cmds = _v0.b;
		return A3(
...
var $author$project$Main$processStateNotif = function (_v0) {
	...
	switch (state.$) {
		case 'Won':
			return A2(
				$author$project$Main$notifySuccess,
				$author$project$I18n$GameWin,
				_Utils_Tuple2(model, cmds));
		case 'Lost':
			return A2(
				$author$project$Main$notifyInfo,
				$author$project$I18n$GameLost,
				_Utils_Tuple2(model, cmds));
		default:
			return _Utils_Tuple2(model, cmds);
	}
...
var $author$project$Store$updateSettings = F2(
...
var $author$project$I18n$AbsentFromDictionary = function (a) {
	return {$: 'AbsentFromDictionary', a: a};
};
var $author$project$I18n$NotEnoughLetters = {$: 'NotEnoughLetters'};
...
var $author$project$Game$letterIs = F2(
	function (build, _char) {
		return $elm$core$Basics$eq(
			build(_char));
	});
var $author$project$Game$handleCorrectDuplicates = F2(
				...
				if (letter.$ === 'Misplaced') {
					...
					var _v1 = _Utils_Tuple2(
						...
						$elm$core$List$length(
							A2(
								$elm$core$List$filter,
								A2($author$project$Game$letterIs, $author$project$Game$Correct, c),
								guess)));
				...
				if (letter.$ === 'Misplaced') {
					...
					var _v1 = _Utils_Tuple2(
						...
						$elm$core$List$length(
							A2(
								$elm$core$List$filter,
								A2($author$project$Game$letterIs, $author$project$Game$Misplaced, c),
								acc)));
...
var $author$project$Game$mapChars = F3(
...
var $author$project$Game$validateGuess = F4(
	function (lang, words, word, input) {
		...
		return (_Utils_cmp(
			...
			$elm$core$String$length(word)) < 0) ? $elm$core$Result$Err($author$project$I18n$NotEnoughLetters) : ((!A2(
			$elm$core$List$member,
			normalize(input),
			words)) ? $elm$core$Result$Err(
			$author$project$I18n$AbsentFromDictionary(
				{lang: lang, word: input})) : $elm$core$Result$Ok(
			A2(
				$author$project$Game$handleMisplacedDuplicates,
				wordChars,
				A2(
					$author$project$Game$handleCorrectDuplicates,
					wordChars,
					A3(
						$elm$core$List$map2,
						$author$project$Game$mapChars(wordChars),
						inputChars,
						wordChars)))));
	});
	...
	function (msg, model) {
		...
		while (true) {
			switch (_v0.a.$) {
				...
				case 'CloseModal':
					var _v4 = _v0.a;
					return $author$project$Main$handleHelpViewed(
						_Utils_Tuple2(
							_Utils_update(
								model,
							...
							_Utils_update(
								model,
								{
									state: A3(
										...
										word,
										guesses,
										A3($author$project$Main$addChar, model.wordSize, _char, input))
								}),
				...
				case 'NewGame':
					...
					return _Utils_Tuple2(
						$author$project$Main$initialModel(store),
						$author$project$Main$startNewGame(store));
				case 'NewTime':
					var time = _v0.a.a;
					return _Utils_Tuple2(
						_Utils_update(
					...
					if (_v0.b.$ === 'Ongoing') {
						...
						if (_v13.$ === 'Ok') {
							...
							return $author$project$Main$logResult(
								$author$project$Main$processStateNotif(
									_Utils_Tuple2(
										_Utils_update(
											model,
											{
												state: A3(
													$author$project$Game$checkGame,
													$author$project$Main$maxAttempts,
													word,
				...
				case 'SwitchLang':
					...
					return A2(
						$author$project$Main$notifySuccess,
						$author$project$I18n$NewGameLang(
							{lang: newStore.lang}),
						_Utils_Tuple2(
							newModel,
							$elm$core$Platform$Cmd$batch(
				...
				case 'SwitchLayout':
					var layout_ = _v0.a.a;
					var newStore = A2(
						$author$project$Store$updateSettings,
						function (s) {
							return _Utils_update(
								s,
								{layout: layout_});
				...
				case 'SwitchWordSize':
					if (_v0.a.a.$ === 'Just') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								newModel,
								{store: newStore, wordSize: wordSize}),
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
					...
					if (_v0.a.a.$ === 'Ok') {
						...
						var words = A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$elm$core$String$length,
								$elm$core$Basics$eq(model.wordSize)),
							A2(
								$elm$core$List$filter,
								A2($elm$core$Basics$composeL, $elm$core$Basics$not, $elm$core$String$isEmpty),
								$elm$core$String$lines(rawWords)));
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{words: words}),
...
var $author$project$I18n$Definition = {$: 'Definition'};
var $author$project$Icon$Definition = {$: 'Definition'};
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						...
						'icon icon-' + $author$project$Icon$nameToString(name)),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Icon$Definition,
					_List_fromArray(
						[
...
var $author$project$I18n$PlayAgain = {$: 'PlayAgain'};
var $author$project$Icon$PlayAgain = {$: 'PlayAgain'};
...
var $author$project$I18n$Help = {$: 'Help'};
var $author$project$I18n$Settings = {$: 'Settings'};
var $author$project$I18n$StatsLang = function (a) {
	return {$: 'StatsLang', a: a};
};
...
var $author$project$Icon$Help = {$: 'Help'};
var $author$project$Main$OpenModal = function (a) {
	return {$: 'OpenModal', a: a};
};
var $author$project$Icon$Settings = {$: 'Settings'};
var $author$project$Main$SettingsModal = {$: 'SettingsModal'};
var $author$project$Icon$Stats = {$: 'Stats'};
var $author$project$I18n$StatsButton = {$: 'StatsButton'};
var $author$project$Main$StatsModal = {$: 'StatsModal'};
var $author$project$Main$SwitchLang = function (a) {
	return {$: 'SwitchLang', a: a};
};
							...
							[
								...
								_List_fromArray(
									[
										...
										btnClass(
										_Utils_eq(store.lang, $author$project$I18n$English)),
										$elm$html$Html$Events$onClick(
										$author$project$Main$SwitchLang($author$project$I18n$English))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$class('HeaderButton btn btn-sm text-truncate'),
										btnClass(
										_Utils_eq(store.lang, $author$project$I18n$French)),
										$elm$html$Html$Events$onClick(
										$author$project$Main$SwitchLang($author$project$I18n$French))
									]),
								_List_fromArray(
									[
							...
							[
								...
								_List_fromArray(
									[
										...
										_Utils_eq(
											modal,
											$elm$core$Maybe$Just($author$project$Main$StatsModal))),
										$elm$html$Html$Events$onClick(
										$author$project$Main$OpenModal($author$project$Main$StatsModal)),
										A2(
										$elm$html$Html$Attributes$attribute,
										'aria-label',
										A2($author$project$I18n$translate, store.lang, $author$project$I18n$StatsButton))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										_Utils_eq(
											modal,
											$elm$core$Maybe$Just($author$project$Main$HelpModal))),
										$elm$html$Html$Events$onClick(
										$author$project$Main$OpenModal($author$project$Main$HelpModal)),
										A2(
										$elm$html$Html$Attributes$attribute,
										'aria-label',
										A2($author$project$I18n$translate, store.lang, $author$project$I18n$Help))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										_Utils_eq(
											modal,
											$elm$core$Maybe$Just($author$project$Main$SettingsModal))),
										$elm$html$Html$Events$onClick(
										$author$project$Main$OpenModal($author$project$Main$SettingsModal)),
										A2(
										$elm$html$Html$Attributes$attribute,
										'aria-label',
										A2($author$project$I18n$translate, store.lang, $author$project$I18n$Settings))
									]),
								_List_fromArray(
									[
...
var $author$project$I18n$HelpGamePitch = function (a) {
	return {$: 'HelpGamePitch', a: a};
};
var $author$project$I18n$HelpInThisExample = {$: 'HelpInThisExample'};
var $author$project$I18n$HelpInspiredBy = function (a) {
	return {$: 'HelpInspiredBy', a: a};
};
var $author$project$I18n$HelpKeyboard = {$: 'HelpKeyboard'};
var $author$project$I18n$HelpKeyboardLetter = {$: 'HelpKeyboardLetter'};
var $author$project$I18n$HelpLetterCorrectlyPlaced = function (a) {
	return {$: 'HelpLetterCorrectlyPlaced', a: a};
};
var $author$project$I18n$HelpLetterMisplaced = function (a) {
	return {$: 'HelpLetterMisplaced', a: a};
};
var $author$project$I18n$HelpLetterUnused = function (a) {
	return {$: 'HelpLetterUnused', a: a};
};
...
var $author$project$I18n$paragraph = F2(
	function (lang, id) {
		return A2(
			$elm$html$Html$p,
			_List_Nil,
...
var $author$project$Main$viewHelp = F2(
	function (_v0, wordSize) {
		var lang = _v0.lang;
		var demo = _List_fromArray(
			[
				$author$project$Game$Correct(
				_Utils_chr('m')),
				$author$project$Game$Misplaced(
				_Utils_chr('e')),
				$author$project$Game$Unused(
				_Utils_chr('t')),
				$author$project$Game$Correct(
				_Utils_chr('a')),
				$author$project$Game$Unused(
		...
		return _List_fromArray(
			[
				A2(
				$author$project$I18n$paragraph,
				lang,
				$author$project$I18n$HelpGamePitch(
					{lang: lang, maxGuesses: $author$project$Main$maxAttempts, nbLetters: wordSize})),
				...
				A2(
					...
					$author$project$I18n$HelpInspiredBy(
						{githubUrl: 'https://github.com/n1k0/wordlem', wordleUrl: 'https://www.powerlanguage.co.uk/wordle/'})))
			]);
	});
				...
				[
					...
					_List_fromArray(
						[
							...
							'mouseup',
							$elm$json$Json$Decode$succeed(
								{message: $author$project$Main$CloseModal, preventDefault: true, stopPropagation: true}))
						]),
					_List_fromArray(
						[
							A2(
...
var $author$project$I18n$SettingsKeyboardLayout = {$: 'SettingsKeyboardLayout'};
var $author$project$I18n$SettingsWordSize = {$: 'SettingsWordSize'};
var $author$project$I18n$SettingsWordSizeInt = function (a) {
	return {$: 'SettingsWordSizeInt', a: a};
};
var $author$project$I18n$SettingsWordSizeRandom = {$: 'SettingsWordSizeRandom'};
var $author$project$Main$SwitchLayout = function (a) {
	return {$: 'SwitchLayout', a: a};
};
var $author$project$Main$SwitchWordSize = function (a) {
	return {$: 'SwitchWordSize', a: a};
};
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($elm$core$Basics$composeR, $author$project$Keyboard$layoutFromString, $author$project$Main$SwitchLayout))
						]),
					A2(
						$elm$core$List$map,
						function (l) {
							return A2(
								...
								_List_fromArray(
									[
										...
										$author$project$Keyboard$layoutToString(l)),
										$elm$html$Html$Attributes$selected(
										_Utils_eq(l, settings.layout))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
						...
						_List_fromArray(
							[$author$project$Keyboard$Auto, $author$project$Keyboard$Azerty, $author$project$Keyboard$Qwerty])))
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('form-select w-100 mt-1'),
							$elm$html$Html$Events$onInput(
							A2($elm$core$Basics$composeR, $elm$core$String$toInt, $author$project$Main$SwitchWordSize))
						]),
					A2(
						$elm$core$List$map,
						function (_v1) {
							...
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$selected(
										_Utils_eq(wordSize, settings.wordSize)),
										$elm$html$Html$Attributes$value(
										A2(
											$elm$core$Maybe$withDefault,
											'',
											A2($elm$core$Maybe$map, $elm$core$String$fromInt, wordSize)))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										A2($author$project$I18n$translate, lang, i18n))
									]));
						},
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
								$elm$core$Maybe$Just(5),
								$author$project$I18n$SettingsWordSizeInt(
									{size: 5})),
								_Utils_Tuple2(
...
var $author$project$I18n$StatsLangDataMissing = function (a) {
	return {$: 'StatsLangDataMissing', a: a};
};
var $author$project$I18n$StatsAverageGuesses = {$: 'StatsAverageGuesses'};
var $author$project$I18n$StatsGamesPlayed = {$: 'StatsGamesPlayed'};
var $author$project$I18n$StatsGuessDistribution = function (a) {
	return {$: 'StatsGuessDistribution', a: a};
};
var $author$project$I18n$StatsGuessEvolution = function (a) {
	return {$: 'StatsGuessEvolution', a: a};
};
var $author$project$I18n$StatsGuessEvolutionHelp = function (a) {
	return {$: 'StatsGuessEvolutionHelp', a: a};
};
var $author$project$I18n$StatsWinRate = {$: 'StatsWinRate'};
						...
						switch (modal.a.$) {
							case 'HelpModal':
								...
								return A3(
									...
									A2($author$project$Main$viewHelp, store, model.wordSize));
							case 'SettingsModal':
								var _v2 = modal.a;
								return A3(
									$author$project$Main$viewModal,
									store,
									$author$project$I18n$Settings,
									$author$project$Main$viewSettings(store));
							default:
								var _v3 = modal.a;
								return A3(
									$author$project$Main$viewModal,
...
var $author$project$Main$viewBoard = F3(
	function (wordSize, input, guesses) {
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class(
							'Board Board-' + $elm$core$String$fromInt(wordSize)),
							A2(
							$elm$html$Html$Attributes$style,
							'grid-template-rows',
							A2(
						...
						$elm$core$List$concat(
							_List_fromArray(
								[
									...
									A2(
										$elm$core$Basics$composeR,
										$author$project$Main$viewAttempt(wordSize),
										$elm$core$Maybe$Just),
									...
									[
										A2(
										$elm$core$Maybe$map,
										$author$project$Main$viewInput(wordSize),
										input)
									]),
									A2(
									$elm$core$List$map,
...
var $author$project$I18n$DecodeError = {$: 'DecodeError'};
...
var $author$project$Keyboard$disposition = F2(
	function (lang, layout) {
		disposition:
		while (true) {
			switch (layout.$) {
				case 'Auto':
					var $temp$lang = lang,
						$temp$layout = $author$project$Keyboard$defaultLangLayout(lang);
					lang = $temp$lang;
					layout = $temp$layout;
...
var $author$project$Keyboard$keyState = F2(
	function (guesses, _char) {
		return _Utils_Tuple2(
			...
			A2(
				$elm$core$List$any,
				$elm$core$List$any(
					A2($author$project$Game$letterIs, $author$project$Game$Correct, _char)),
				guesses) ? $elm$core$Maybe$Just(
				$author$project$Game$Correct(_char)) : (A2(
				$elm$core$List$any,
				$elm$core$List$any(
					A2($author$project$Game$letterIs, $author$project$Game$Misplaced, _char)),
				guesses) ? $elm$core$Maybe$Just(
				$author$project$Game$Misplaced(_char)) : (A2(
				$elm$core$List$any,
				$elm$core$List$any(
					A2($author$project$Game$letterIs, $author$project$Game$Unused, _char)),
				guesses) ? $elm$core$Maybe$Just(
				$author$project$Game$Unused(_char)) : $elm$core$Maybe$Nothing)));
	});
var $author$project$Icon$Backspace = {$: 'Backspace'};
var $author$project$Icon$Enter = {$: 'Enter'};
var $author$project$Main$viewKeyState = function (_v0) {
	...
	var _v1 = function () {
		...
		return _Utils_eq(
			_char,
			_Utils_chr('⌫')) ? _Utils_Tuple2('btn-info large-key', $author$project$Main$BackSpace) : (_Utils_eq(
			_char,
			_Utils_chr('⏎')) ? _Utils_Tuple2('btn-info large-key', $author$project$Main$Submit) : _Utils_Tuple2(
			'btn-secondary',
			$author$project$Main$KeyPressed(_char)));
	}();
	var classes = _v1.a;
			...
			A2(
				...
				A2(
					...
					$elm$core$List$map(
						A2(
							$elm$core$Basics$composeR,
							$author$project$Keyboard$keyState(guesses),
							$author$project$Main$viewKeyState))),
				A2($author$project$Keyboard$disposition, lang, settings.layout)));
	});
